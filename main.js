...
/**
 * Vygeneruje pole zamestnancov.
 * @param {object} dtoIn - Vstupné parametre (count, min/max age).
 * @returns {Array<object>} Pole zamestnancov.
 */
...
/**
 * Vypočíta počet zamestnancov podľa workloadov.
